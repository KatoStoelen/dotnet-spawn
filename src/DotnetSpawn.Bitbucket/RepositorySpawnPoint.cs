    ...
    internal class RepositorySpawnPoint : ISpawnPoint<RepositorySpawnPoint.Inputs>
    {
            ...
            Inputs inputs, IConsole console, CancellationToken cancellationToken)
        {
            try
            {
                ...
                console.LogInformation($"Creating Bitbucket repository '{inputs.Name}' in project '{inputs.ProjectKey}'...");
                ...
                console.LogInformation($"Bitbucket repository created @ {BrowseUrl}");
